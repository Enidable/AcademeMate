...
export const STUDY_LOG_HEADER = 'id,date,start_time,end_time,duration_hours,duration_minutes,course_id,category,project,location,efficiency,wellbeing,lecture_id,transport_mode,commute_minutes,notes,plan_id,lecture_content_id,event_id,recap_summary'
...
export const ADDITIONAL_HEADER = 'id,date,category,task,hours,start_time,end_time,efficiency,wellbeing,location,notes,done,event_id'
